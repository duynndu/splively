    ...
    <div class="container-fluid">
        ...
        <div class="prs_navi_left_main_wrapper">
            <div class="prs_logo_main_wrapper">
                <a href="index.html">
                    <img src="/assets/client/images/header/logo.png" alt="logo" />
                </a>
            </div>
                ...
                <nav class="navbar navbar-default">
                    <div id="dl-menu" class="xv-menuwrapper responsive-menu">
                        <button class="dl-trigger">
                            <img src="/assets/client/images/header/bars.png" alt="bar_png">
                        </button>
                                    ...
                                    <li>
                                        <div class="prs_navi_slider_wraper">
                                            <div class="owl-carousel owl-theme">
                                                <div class="item">
                                                    <img src="/assets/client/images/content/up1.jpg" alt="navi_img">
                                                </div>
                                                <div class="item">
                                                    <img src="/assets/client/images/content/up2.jpg" alt="navi_img">
                                                </div>
                                                <div class="item">
                                                    <img src="/assets/client/images/content/up3.jpg" alt="navi_img">
                                                </div>
                                            </div>
                                        </div>
                                    </li>
                                ...
                                <ul class="lg-submenu prs_navi_video_wrapper">
                                    <li>
                                        <div class="prs_video_navi_img_main_wrapper">
                                            <img src="/assets/client/images/content/vp1.jpg" alt="video_img">
                                    ...
                                    <li>
                                        <div class="prs_video_navi_img_main_wrapper">
                                            <img src="/assets/client/images/content/vp2.jpg" alt="video_img">
                                            <div class="prs_video_navi_overlay_wrapper">	<a class="test-popup-link button" rel='external' href='https://www.youtube.com/embed/ryzOXAO0Ss0' title='title'><i class="flaticon-play-button"></i></a>
                                            </div>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="prs_video_navi_img_main_wrapper">
                                            <img src="/assets/client/images/content/vp3.jpg" alt="video_img">
                                            <div class="prs_video_navi_overlay_wrapper">	<a class="test-popup-link button" rel='external' href='https://www.youtube.com/embed/ryzOXAO0Ss0' title='title'><i class="flaticon-play-button"></i></a>
                                            </div>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="prs_video_navi_img_main_wrapper">
                                            <img src="/assets/client/images/content/vp4.jpg" alt="video_img">
                                            <div class="prs_video_navi_overlay_wrapper">	<a class="test-popup-link button" rel='external' href='https://www.youtube.com/embed/ryzOXAO0Ss0' title='title'><i class="flaticon-play-button"></i></a>
                                            </div>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="prs_video_navi_img_main_wrapper">
                                            <img src="/assets/client/images/content/vp5.jpg" alt="video_img">
                                            <div class="prs_video_navi_overlay_wrapper">	<a class="test-popup-link button" rel='external' href='https://www.youtube.com/embed/ryzOXAO0Ss0' title='title'><i class="flaticon-play-button"></i></a>
                                            </div>
                                        </div>
                                    </li>
                                    <li class="hidden-sm">
                                        <div class="prs_video_navi_img_main_wrapper">
                                            <img src="/assets/client/images/content/vp6.jpg" alt="video_img">
                                            <div class="prs_video_navi_overlay_wrapper">	<a class="test-popup-link button" rel='external' href='https://www.youtube.com/embed/ryzOXAO0Ss0' title='title'><i class="flaticon-play-button"></i></a>
                                            </div>
                                        </div>
                                    </li>

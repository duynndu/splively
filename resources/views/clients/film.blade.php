					...
					<div class="st_video_slider_inner_wrapper float_left">
						...
						<div class="st_video_slide_sec float_left">
							<a rel='external' href='https://www.youtube.com/embed/ryzOXAO0Ss0' title='title' class="test-popup-link">
								<img src="/assets/client/images/index_III/icon.png" alt="img">
							</a>
							<h3>Aquaman</h3>
				...
				<div class="st_slider_rating_btn prs_animate_btn1">
					<ul>
						<li data-animation="animated fadeInUp">
							<a href="/film/haha/movie-booking" class="button button--tamaya prs_upcom_main_btn" data-text="book now">
								<span>book now</span>
							</a>
						</li>
					</ul>
								...
								<div class="row">
									...
									<div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-12">
										<div class="st_md_ts_main_sec float_left">
											<img src="/assets/client/images/content/md1.png" alt="img">
									...
									<div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-12">
										<div class="st_md_ts_main_sec float_left">
											<img src="/assets/client/images/content/md2.png" alt="img">
									...
									<div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-12">
										<div class="st_md_ts_main_sec float_left">
											<img src="/assets/client/images/content/md3.png" alt="img">
													...
													<div class="owl-carousel owl-theme">
														<div class="item">
															<div class="st_summ_slider_cont float_left">
																<img src="/assets/client/images/content/c1.jpg" alt="img">
														...
														<div class="item">
															<div class="st_summ_slider_cont float_left">
																<img src="/assets/client/images/content/c2.jpg" alt="img">
														...
														<div class="item">
															<div class="st_summ_slider_cont float_left">
																<img src="/assets/client/images/content/c3.jpg" alt="img">
														...
														<div class="item">
															<div class="st_summ_slider_cont float_left">
																<img src="/assets/client/images/content/c4.jpg" alt="img">
											...
											<div class="col-md-12">
												<div class="st_md_summ_client_slider float_left">
													...
													<div class="owl-carousel owl-theme">
														<div class="item">
															<div class="st_summ_slider_cont float_left">
																<img src="/assets/client/images/content/c5.jpg" alt="img">
														...
														<div class="item">
															<div class="st_summ_slider_cont float_left">
																<img src="/assets/client/images/content/c6.jpg" alt="img">
														...
														<div class="item">
															<div class="st_summ_slider_cont float_left">
																<img src="/assets/client/images/content/c7.jpg" alt="img">
														...
														<div class="item">
															<div class="st_summ_slider_cont float_left">
																<img src="/assets/client/images/content/c8.jpg" alt="img">
										...
										<div class="row">
											<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
												<div class="prs_ms_scene_slider_img prs_ms_scene_slider_img22">
													<img src="/assets/client/images/content/movie_single/sc1.jpg" alt="scene_img">
													<div class="prs_ms_scene_img_overlay">	<a href="/assets/client/images/content/movie_single/sc1.jpg" class="venobox info" data-title="PORTFOLIO TITTLE" data-gall="gall12"><i class="flaticon-tool"></i></a>
													</div>
												</div>
											</div>
											<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
												<div class="prs_ms_scene_slider_img prs_ms_scene_slider_img22">
													<img src="/assets/client/images/content/movie_single/sc2.jpg" alt="scene_img">
													<div class="prs_ms_scene_img_overlay">	<a href="/assets/client/images/content/movie_single/sc2.jpg" class="venobox info" data-title="PORTFOLIO TITTLE" data-gall="gall12"><i class="flaticon-tool"></i></a>
													</div>
												</div>
											</div>
											<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
												<div class="prs_ms_scene_slider_img prs_ms_scene_slider_img22">
													<img src="/assets/client/images/content/movie_single/sc3.jpg" alt="scene_img">
													<div class="prs_ms_scene_img_overlay">	<a href="/assets/client/images/content/movie_single/sc3.jpg" class="venobox info" data-title="PORTFOLIO TITTLE" data-gall="gall12"><i class="flaticon-tool"></i></a>
													</div>
												</div>
											</div>
											<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
												<div class="prs_ms_scene_slider_img prs_ms_scene_slider_img22">
													<img src="/assets/client/images/content/movie_single/sc4.jpg" alt="scene_img">
													<div class="prs_ms_scene_img_overlay">	<a href="/assets/client/images/content/movie_single/sc4.jpg" class="venobox info" data-title="PORTFOLIO TITTLE" data-gall="gall12"><i class="flaticon-tool"></i></a>
													</div>
												</div>
											</div>
											<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
												<div class="prs_ms_scene_slider_img prs_ms_scene_slider_img22">
													<img src="/assets/client/images/content/movie_single/sc5.jpg" alt="scene_img">
													<div class="prs_ms_scene_img_overlay">	<a href="/assets/client/images/content/movie_single/sc5.jpg" class="venobox info" data-title="PORTFOLIO TITTLE" data-gall="gall12"><i class="flaticon-tool"></i></a>
													</div>
												</div>
											</div>
											<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
												<div class="prs_ms_scene_slider_img prs_ms_scene_slider_img22">
													<img src="/assets/client/images/content/movie_single/sc6.jpg" alt="scene_img">
													<div class="prs_ms_scene_img_overlay">	<a href="/assets/client/images/content/movie_single/sc6.jpg" class="venobox info" data-title="PORTFOLIO TITTLE" data-gall="gall12"><i class="flaticon-tool"></i></a>
													</div>
												</div>
											</div>
										</div>
						...
						<div class="row">
							...
							<div class="col-md-12">
								<div class="st_ind_sidebar_advertiz st_ind_sidebar_advertiz_md float_left">
									<a href="#">
										<img src="/assets/client/images/index_III/add.png" alt="img">
									</a>
								</div>
							</div>
							<div class="col-md-12">
